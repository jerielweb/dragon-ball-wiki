...
import { ARROW_R } from "@/components";
import type { Item } from "@/types/types.pages";
import Image from "next/image";
import Link from "next/link";
import { PAGINATION_BUTTON } from "@/components";
...
export default async function Charaters({
  ...
  return (
    <main
      id="home"
      className="size-full min-h-screen flex flex-col items-center justify-center"
    >
      <div className="container mx-auto px-4 py-8 flex flex-col items-center justify-center">
        <h1 className="text-4xl font-bold mb-8 text-center">Personajes</h1>
        <PAGINATION_BUTTON
